...
import com.siddharthks.bubbles.FloatingBubbleLogger;
...
public class FloatingBubbleService extends Service {
    ...
    protected void setupViews() {
        ...
        // Setting up view
        bubbleView = inflater.inflate(com.siddharthks.bubbles.R.layout.floating_bubble_view, null);
        removeBubbleView = inflater.inflate(com.siddharthks.bubbles.R.layout.floating_remove_bubble_view, null);
        expandableView = inflater.inflate(com.siddharthks.bubbles.R.layout.floating_expandable_view, null);
